...
$link = new Connection;
$query = "SELECT * FROM ket_qua LEFT OUTER JOIN khoa_hoc ON ket_qua.khoa_hoc = khoa_hoc.id
LEFT OUTER JOIN de_thi ON  ket_qua.de_thi = de_thi.ma_de_thi LEFT OUTER JOIN users ON ket_qua.username = users.username;";
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <strong class="card-title">Lịch sử làm bài thi trên hệ thống</strong>
                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        while ($result = $results->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $result['ten_de_thi'] ?></td>
